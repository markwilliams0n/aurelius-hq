...
import { Brain, Clock, HeartPulse, Play, CheckCircle, AlertCircle, Loader2, User, Building, FolderKanban, ChevronDown, ChevronRight, Sparkles } from "lucide-react";
...
export function MemorySidebar({ isOpen, onClose, conversationId }: MemorySidebarProps) {
  ...
  return (
    <RightSidebar
      title="Memories"
      icon={<Brain className="w-4 h-4 text-gold" />}
      onClose={onClose}
      modal
      width={384}
      subHeader={tabs}
