...
Your tools here are save_to_vault, search_vault, and update_vault_item.
...
- When the user says something is wrong or needs correcting, use search_vault then update_vault_item
