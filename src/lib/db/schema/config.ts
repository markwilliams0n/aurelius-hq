...
export const configKeyEnum = pgEnum("config_key", ["soul", "system_prompt", "agents", "processes", "capability:tasks", "capability:config", "prompt:email_draft", "capability:slack", "slack:directory", "capability:vault", "capability:code", "capability:gmail", "capability:browser", "sync:gmail", "sync:granola", "sync:linear", "sync:slack", "capability:code-agent", "email:preferences"]);
